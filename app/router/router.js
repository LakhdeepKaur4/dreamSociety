...
module.exports = function (app) {
	...
	app.put('/api/ownerMember/delete/:id', [authJwt.verifyToken,authJwt.isAdminRole,authJwt.isAdminRole], owner.deleteMember);

	app.post('/api/tenant', [authJwt.verifyToken,authJwt.isAdminRole,authJwt.isAdminRole], tenant.createEncrypted);

	app.get('/api/tenant', [authJwt.verifyToken,authJwt.isAdminRole,authJwt.isAdminRole], tenant.getDecrypted);

	app.put('/api/tenant/delete/deleteSelected', [authJwt.verifyToken,authJwt.isAdminRole,authJwt.isAdminRole], tenant.deleteSelected);
