    ...
    render (){
        ...
        form= <div>
                    ...
                    <div>
                        ...
                        <input  type="text" placeholder="Location Name" className ="form-control" name="locationName" maxLength={0}   onChange={this.onChange}  onKeyPress={this.OnKeyPresshandler} ></input>
