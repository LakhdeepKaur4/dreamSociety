...
deleteSelected(ids){
    console.log('deleteSelected',ids)
...
console.log("editMember",memberId, memberName,gender,memberDob,relationId  )
this.setState({loading: true})
this.setState({ modal: !this.state.modal })
        ...
        addMember=()=>{
            ...
            console.log("=============999999999999999",memberName,memberDob,gender,relationId,id)
            // this.setState({loading: true})
            // this.setState({ formModal: !this.state.formModal })
            // this.props.addNewMember(memberName,memberDob,gender,relationId,id)
            // .then(()=>this.props.getOwnerMember(id).then(() => this.setState({ loading: false })))
