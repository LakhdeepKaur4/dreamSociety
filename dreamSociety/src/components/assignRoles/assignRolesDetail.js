...
//                 //     })
//             this.setState({
//                 editRolesData: { cityId, countryId, stateId, cityName },
//                 modal: !this.state.modal
//             })
...
//         let { isActive } = this.state.editRolesData
//         this.setState({ loading: true })

    
//         this.props.deleteCity(cityId, isActive)
//             .then(() => this.refreshData())
//         this.setState({ editRolesData: { isActive: false } })
...
//                                 filterName:'roleName'}});
//                         }} >Role Type <i className="fa fa-arrows-v" id="sortArrow" aria-hidden="true"></i></th>
...
// export default connect(mapStateToProps, mapDispatchToProps)(CityMasterDetail);