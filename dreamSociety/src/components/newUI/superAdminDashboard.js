            ...
            <div>
                ...
                <div className="wrapper">
                    ...
                    <nav id="sidebar" className="bg-dark inactive">
                        <Menu.Item className="text-center h1 mr-4 mt-4 mb-4 border-bottom-1"><Icon className='col' name="user" /><div className='col ml-2' style={{ fontSize: "0.8rem" }}><Link to="/superDashboard/registration">Super Admin Register</Link></div></Menu.Item>
