                ...
                <div className="wrapper" style={{ backgroundImage: `url('assets/society.jpg')` }}>
                    ...
                    <nav id="sidebarOwner" className="bg-light inactive">
                        <div id="sidebarOwner-content">
                            ...
                            <Menu.Item className="text-center h1 mr-4 mt-4 mb-4"><Icon className='col' name="user" /><div className='col ml-2 pb-3 border border-white border-left-0 border-right-0 border-top-0' style={{ fontSize: "0.8rem" }}><Link to="/superDashBoard/addTenant">Add Tenant</Link></div></Menu.Item>
