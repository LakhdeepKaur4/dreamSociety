...
import { URN,ADD_INVENTORY,GET_INVENTORY,UPDATE_INVENTORY,REMOVE_INVENTORY } from '../actions/index';
...
export function updateInventory(assetId,inventoryId,serial,ratePerInventory,assetType,numberOfInventory){
    console.log(assetId)
   const data={
        // assetId,inventoryId,serialNumber,ratePerInventory,assetTypeId,number
        assetId:assetId,
